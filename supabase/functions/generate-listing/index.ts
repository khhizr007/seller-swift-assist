...
const IMAGE_PROMPTS = [
  ...
  "Show this exact product styled attractively on a soft pastel gradient background (light pink to peach), with gentle shadows and a subtle reflection. Clean, modern Indian ecommerce catalog style. Keep the product identical — do not redesign it.",
];
